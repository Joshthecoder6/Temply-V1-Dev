...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  try {
    ...
    return { shop: session.shop, pages: enrichedPages, planName };
  } catch (error) {
    console.error('Error loading pages:', error);
    return { shop: session.shop, pages: [], planName: "Free" };
  }
};
...
export default function Dashboard() {
  const { shop, pages, planName } = useLoaderData<typeof loader>();
